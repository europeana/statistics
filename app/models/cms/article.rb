class Cms::Article < ActiveRecord::Base
  ...
  #ACCESSORS
  attr_accessible :description, :is_published, :published_at, :title, :tag, :home_page, :position, :archieved, :is_deleted, :is_autogenerated,:has_nested_pages, :nested_pages
