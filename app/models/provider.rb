...
class Provider < ActiveRecord::Base
  ...
  def self.testing_updater
    ...
    #   # Now add or update to Media type table      
    #   file_name = provider_name + " Media Type"
    #   Data::Filz.where(file_file_name: file_name).first.update_attributes({content: media_type_data_formatted.to_json})
    # end
    ...
    #   # Now add or update to Reusable type table      
    #   file_name = provider_name + " Reusable"
    #   Data::Filz.where(file_file_name: file_name).first.update_attributes({content: reusable_data_formatted.to_s})
    # end
